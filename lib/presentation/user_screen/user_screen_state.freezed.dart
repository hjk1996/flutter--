...
class _$_UserScreenState
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('edittedName', edittedName))
      ..add(DiagnosticsProperty('isLoading', isLoading))
      ..add(DiagnosticsProperty('isNameChanged', isNameChanged))
      ..add(DiagnosticsProperty('isPhotoChanged', isPhotoChanged));
  }
